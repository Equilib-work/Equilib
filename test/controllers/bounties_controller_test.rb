...
class BountiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bounty" do
    assert_difference("Bounty.count") do
      post bounties_url, params: { bounty: { amount: @bounty.amount, type: @bounty.type, wallet_id: @bounty.wallet_id } }
    end
  ...
  test "should update bounty" do
    patch bounty_url(@bounty), params: { bounty: { amount: @bounty.amount, type: @bounty.type, wallet_id: @bounty.wallet_id } }
